...
import styles from "./SubScriptionOrder.module.css";
...
export interface SubScriptionOrderProps {
  productName      : string;
  variantName     ?: string;
  freqLabel        : string;
  quantity         : number;
...
const SubScriptionOrder: React.FC<SubScriptionOrderProps> = ({
  productName,
  variantName,
  freqLabel,
  quantity,
        ...
        <div className={styles.MainContainer}>
          ...
          <div className={styles.OrderSummaryContainer}>
            ...
            <div className={styles.OrderSummaryDetails}>
              ...
              {/* Product row — name + price on line 1, freq+bags on line 2 */}
              <div className={styles.productRow}>
                <div className={styles.productRowTop}>
                  <span className={styles.productName}>{displayName}</span>
                  <span className={styles.productPrice}>AED {unitPrice.toFixed(2)}</span>
                </div>
                <p className={styles.freqLabel}>{quantityLabel}</p>
              </div>
